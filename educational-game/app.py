...
def initialize_database():
    """
    Checks if the database file exists. If not, it creates it and
    populates it with data from capitals.json.
    """
    if not os.path.exists(DB_FILE):
        print("Database not found. Creating and populating from capitals.json...")
        try:
